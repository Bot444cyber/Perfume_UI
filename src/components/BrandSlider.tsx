...
const BrandSlider = () => {
    ...
    return (
        <section className="relative w-full bg-black border-y border-white/10 py-10 lg:py-16 overflow-hidden z-20">
            {/* Side Masks */}
            <div className="absolute top-0 left-0 h-full w-20 lg:w-40 bg-gradient-to-r from-black to-transparent z-20 pointer-events-none" />
            <div className="absolute top-0 right-0 h-full w-20 lg:w-40 bg-gradient-to-l from-black to-transparent z-20 pointer-events-none" />
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 mt-3 opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                                        ...
                                        <span className="text-xs uppercase tracking-[0.4em] text-[#D4AF37] font-bold drop-shadow-md">
                                            {brand.sub}
                                        </span>
                                        <span className="h-px w-6 bg-[#D4AF37]" />
                                    </div>
                                    ...
                                    {/* Subtle Reflection */}
                                    <div className="absolute top-full left-0 w-full h-1/2 opacity-0 group-hover:opacity-10 scale-y-[-0.5] origin-top bg-gradient-to-b from-[#D4AF37] to-transparent blur-sm pointer-events-none transition-opacity duration-300" />
                                </motion.div>
                            )
                        })}
                    </motion.div>
