    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white selection:bg-teal-500/30 font-sans">
            ...
            <div className="flex flex-col lg:flex-row min-h-screen">
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#050505] lg:to-transparent z-10 opacity-60" />
                    <img
                        src={product.image}
                        alt={product.name}
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 lg:px-24 py-16 lg:py-32 relative z-20 bg-[#050505]">

                    {/* Back Link */}
                    <Link href="/collections" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-bold tracking-[0.2em] mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {[
                                    ...
                                    <div key={item.title} className="flex flex-col gap-2">
                                        <span className="text-[10px] text-teal-500/80 uppercase tracking-widest font-bold">{item.title}</span>
                        ...
                        <div className="flex flex-col gap-6 mb-24">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <a
                                    ...
                                    className="group flex-1 h-14 bg-white text-black flex items-center justify-center gap-3 font-bold uppercase tracking-[0.2em] text-xs hover:bg-teal-400 transition-colors duration-500"
                                >
                                    <span>Contact Concierge</span>
                                    <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                                </a>
                                <a href="tel:+15550000000" className="md:w-auto h-14 px-8 border border-white/10 flex items-center justify-center gap-3 text-white hover:bg-white/5 transition-colors group">
                                    <Phone className="w-4 h-4 text-zinc-500 group-hover:text-white transition-colors" />
                                    <span className="text-xs font-bold uppercase tracking-widest text-zinc-400 group-hover:text-white transition-colors">+1 (555) 000-0000</span>
                                </a>
                            </div>
